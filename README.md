...
- **Responsive Design:** Fluid layout optimized for both desktop and mobile viewports.
...
3. Launch the project:
   - If you manage to clone the repository just type "ng Serve" in the terminal to launch the whole project.
...
- GitHub: [@Jampoy791](https://github.com)
- Email: Jaypeeeev@gmail.com
